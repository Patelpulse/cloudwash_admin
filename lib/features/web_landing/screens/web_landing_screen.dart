            ...
            Expanded(
              child: GridView.count(
                ...
                children: [
                  ...
                  _SectionCard(
                    title: 'Blog',
                    description: 'Manage dynamic blog posts and articles',
                    icon: Icons.article_outlined,
                    color: Colors.orange.shade100,
                    onTap: () => context.go('/web-landing/blog'),
                  ),
                  _SectionCard(
                    title: 'Contact',
                    description: 'Edit email, phone, address, and hours',
                    icon: Icons.contact_support_outlined,
                    color: Colors.teal.shade100,
                    onTap: () => context.go('/web-landing/contact'),
                  ),
                ],
              ),
            ),
